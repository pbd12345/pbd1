...
if (typeof window.defaultResponsiveData === 'undefined') window.defaultResponsiveData = [false, true, false, true, false, ];

resizeData['object1570870508'] = {
   responsive: [
...
resizeData['headline'] = {
   responsive: [
                  { left: 0.12, top: 0.48, visible: true }, 
                  { left: 0.12, top: 0.48, visible: true }, 
                  { left: 0.12, top: 0.48, visible: true }, 
                  { left: 0.12, top: 0.48, visible: true }, 
                  { left: 0.12, top: 0.48, visible: true }, 
